...
<div class="container">
<h2>Data Murabbi</h2>
<form method="post" action="data_murabbi.php">
<div class="row">
...
<table class="border striped">
	<tr>
		...
		<th>Jumlah Binaan Aktif</th>
		<th>Tindakan</th>
	</tr>
	<?php
	$i = 1;
	$select = $koneksi->prepare("SELECT murabbi.id_murabbi, murabbi.nama_murabbi, murabbi.prodi, murabbi.angkatan from murabbi WHERE murabbi.nama_murabbi != 'LTT' and murabbi.nama_murabbi != 'Uji Coba' and murabbi.jenis_kelamin = '$jenis_kelamin_pilih' GROUP BY murabbi.nama_murabbi ORDER BY murabbi.nama_murabbi ASC;");
				$select->execute();
				$select->store_result();
				...
				$sql2 = "SELECT mutarabbi.nama_mutarabbi from mutarabbi where mutarabbi.nama_murabbi='$nama_murabbi' and mutarabbi.status='Aktif' ORDER BY mutarabbi.nama_mutarabbi";
	...
	<tr>
		...
		<td><?=$jumlah_binaan;?></td>
		<td><a href="lihat_kelompok.php?id=<?=$id_murabbi;?>">Lihat</a> | <a href="edit_murabbi.php?id=<?=$id_murabbi;?>">Edit</a> | <a href="hapus_murabbi.php?id=<?=$id_murabbi;?>" onclick="return confirm('Yakin Ingin Menghapus Murabbi serta Mutarabbi dan Laporannya?');"">Hapus</a></td>
	</tr>
	<?php
				}
				?>
