...
//Dapatkan user
$select = $koneksi->prepare("SELECT angkatan_kelompok FROM rekap WHERE nama_kelompok='$nama_kelompok';");
$select->execute();
$select->store_result();
    ...
    <nav class="hide-on-med-and-down">
      ...
      <div class="container">
          <div class="col s12">
            ...
            <a href="" class="breadcrumb">Edit Mutarabbi</a>
          </div>
        </div>
      </div>
    </nav>      
...
<form method="post" action="proses_edit.php" onsubmit="return confirm('Yakin Ingin Mengedit Mutarabbi?');">
    ...
    <div class="row">
        <div class="input-field col s12">
            <input type="hidden" name="nama_mutarabbi_lama" value="<?=$nama_mutarabbi_lama;?>">
            <input type="text" name="nama_mutarabbi_baru" value="<?=$nama_mutarabbi_lama;?>" required></br>
