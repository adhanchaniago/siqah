...
$select = $koneksi->prepare("SELECT nama_murabbi, angkatan_kelompok, jenis_kelamin, jenjang FROM rekap WHERE nama_kelompok='$nama_kelompok';");
$select->execute();
$select->store_result();
$select->bind_result($nama_murabbi, $angkatan_kelompok_lama, $jenis_kelamin, $jenjang_lama);
$select->fetch();
...
<form method="post" action="proses_edit_kelompok.php" onsubmit="return confirm('Yakin Ingin Mengedit Kelompok?');">
    ...
    <div class="row">
        <div class="input-field col s12">
            <input type="hidden" name="nama_kelompok_lama" value="<?=$nama_kelompok;?>" placeholder="Nama Kelompok Lama">
            <input type="text" name="nama_kelompok_baru" value="<?=$nama_kelompok;?>" placeholder="Nama Kelompok Baru">
