...
$select = $koneksi->prepare("SELECT nama_murabbi, prodi, angkatan, jenis_kelamin, nama_pengguna, kata_sandi FROM murabbi WHERE id_murabbi=$id_murabbi;");
$select->execute();
$select->store_result();
$select->bind_result($nama_murabbi, $prodi, $angkatan, $jenis_kelamin, $nama_pengguna_baru, $kata_sandi_baru);
$select->fetch();
?>
