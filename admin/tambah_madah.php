      ...
      <div class="nav-wrapper teal darken-3">
        <div class="container">            
            <div class="col s12">
                ...
                <a href="tambah_madah.php" class="breadcrumb">Tambah Madah</a>
            </div>
        </div>
      </div>
    </nav>
...
<div class="container">
<h2>Tambah Madah</h2>
<form method="post" action="proses_tambah_madah.php" onsubmit="return confirm('Yakin Ingin Menambah Madah?');" enctype="multipart/form-data">
    <div class="row">
