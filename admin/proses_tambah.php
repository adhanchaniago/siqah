...
$insert = $koneksi->prepare("INSERT INTO `mutarabbi` (`id_mutarabbi`, `nama_mutarabbi`, `prodi`, `angkatan`, `nama_murabbi`, `jenjang`, `nama_kelompok`, `no_hp`, `alamat`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
$insert->bind_param("issssssss", $id_mutarabbi, $nama_mutarabbi, $prodi, $angkatan, $nama_murabbi, $jenjang, $nama_kelompok, $no_hp, $alamat);
$insert->execute();
