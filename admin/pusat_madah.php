...
<table class="border striped">
    ...
    <td><?php 
        if ($lokasi == "") {
          ?>
          <a href="edit_madah.php?judul=<?=$judul;?>">Edit</a>
          <?php
          } 
        else { 
            ?>
            <a href="<?=$lokasi;?>">Unduh</a> | <a href="edit_madah.php?judul=<?=$judul;?>">Edit</a>
            <?php
          }
        ?>
    </td>
...
<br>
  ...
  <a href="tambah_madah.php" class="btn-floating btn-large waves-effect waves-light red"><i class="material-icons">add</i></a><label> Tambah Madah</label>
</div>
<br>
