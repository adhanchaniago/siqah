...
$select = $koneksi->prepare("SELECT angkatan_kelompok, jenis_kelamin, nama_murabbi FROM rekap WHERE nama_kelompok='$nama_kelompok'");
$select->execute();
$select->store_result();
$select->bind_result($angkatan_kelompok, $jenis_kelamin, $nama_murabbi);
$select->fetch();
...
$select = $koneksi->prepare("SELECT count(nama_mutarabbi) from mutarabbi WHERE nama_murabbi = '$nama_murabbi' and status = 'Aktif' AND nama_kelompok='$nama_kelompok';");
$select->execute();
$select->store_result();
...
//Dapatkan jumlah mutarabbi
$select = $koneksi->prepare("SELECT count(nama_mutarabbi) from mutarabbi WHERE nama_murabbi = '$nama_murabbi' and status = 'Nonaktif' AND nama_kelompok='$nama_kelompok';");
$select->execute();
$select->store_result();
    ...
    <nav class="hide-on-med-and-down">
      ...
      <div class="container">
          <div class="col s12">
            ...
            <a href="" class="breadcrumb">Data Mutarabbi</a>
          </div>
        </div>
      </div>
    </nav>   
...
<table class="bordered striped">
  ...
  <tr>
    ...
    <td><?=$no_hp;?></td>
    <td><?=$alamat;?></td>
    <td><a href="edit.php?id=<?=$id_mutarabbi;?>">Edit</a> | <a href="capaian_madah.php?id=<?=$id_mutarabbi;?>">Capaian Madah</a> | <a href="nonaktif.php?id=<?=$id_mutarabbi;?>" onclick="return confirm('Yakin Ingin Non-Aktifkan Mutarabbi?');">Non-Aktifkan</a></td>
  </tr>
      <?php
       }
        else{
  ...
  <tr style="color: grey;">
    ...
    <td><?=$no_hp;?></td>
    <td><?=$alamat;?></td>
    <td><a href="edit.php?id=<?=$id_mutarabbi;?>">Edit</a> | <a href="capaian_madah.php?id=<?=$id_mutarabbi;?>">Capaian Madah</a> | <a href="aktif.php?id=<?=$id_mutarabbi;?>" onclick="return confirm('Yakin Ingin Aktifkan Mutarabbi?');">Aktifkan</a></td>
  </tr>
          <?php
        }
        }
