    ...
    <nav class="hide-on-med-and-down">
      ...
      <div class="container">
          <div class="col s12">
            ...
            <a href="" class="breadcrumb">Tentang Kami</a>
          </div>
        </div>
      </div>
    </nav>
...
<center>
<div class="row">
    <img src="../icons/Head of Dev.png" style="width:10%;"></br>
    <strong>Head of Development:</strong> Mujahid Robbani Sholahudin
</div>
<div class="row">
    <div class="col s4">
    <img src="../icons/Analyst.png" style="width:30%;"></br>
    <strong>System Analyst:</strong> Naufal Ibnu Salam
    </div>
    <div class="col s4">
    <img src="../icons/Web Prog.png" style="width:30%;"></br>
    <strong>Web Programmer:</strong> Mujahid Robbani Sholahudin
    </div>
    <div class="col s4">
    <img src="../icons/Database.png" style="width:30%;"></br>
    <strong>Database Engineer:</strong> Mujahid Robbani Sholahudin
    </div>
</div>
<div class="row">
    <div class="col s6">
    <img src="../icons/Web Des.png" style="width:20%;"></br>
    <strong>Web Designer:</strong> Rakha Ramadhana A. B.
    </div>
    <div class="col s6">
    <img src="../icons/Graphic Des.png" style="width:20%;"></br>
