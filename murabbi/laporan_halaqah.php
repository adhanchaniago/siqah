...
<table class="bordered striped">
	...
	<tr>
		<td><?=$i++;?></td>
		<td><?=$nama_kelompok;?></td>
		<td><a href="lapor.php?nama=<?=$nama_kelompok;?>">Lapor</a> | <a href="riwayat.php?nama=<?=addslashes($nama_kelompok);?>">Riwayat</a></td>
	</tr>
	<?php
				}
				?>
