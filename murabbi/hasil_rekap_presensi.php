...
<header>
    ...
    <nav>
        ...
        <ul class="left hide-on-med-and-down">
            ...
            <li class="active"><a href="rekap_presensi.php">Rekapitulasi Presensi</a></li>
    ...
    <nav class="hide-on-med-and-down">
      ...
      <div class="container">
          <div class="col s12">
            ...
            <a href="rekap_presensi.php" class="breadcrumb">Rekap Presensi</a>
            <a href="hasil_rekap_presensi.php?nama=<?= stripslashes($nama_kelompok);?>" class="breadcrumb"><?= stripslashes($nama_kelompok);?></a>
          </div>
        </div>
      </div>
    </nav>       
...
//for($k=1;$k<=$jumlah_kelompok;$k++){
    ...
    Jumlah Anggota Aktif: <?=$jumlah_binaan;
    if($bulan_pilihan == 1){
        ?>
...
<?php
    ...
    <tr>
        ...
        <?php
            $data1 = number_format(($binaan_hadir_januari_1/$jumlah_binaan)*100);
            $data2 = number_format(($binaan_hadir_januari_2/$jumlah_binaan)*100);
            $data3 = number_format(($binaan_hadir_januari_3/$jumlah_binaan)*100);
            $data4 = number_format(($binaan_hadir_januari_4/$jumlah_binaan)*100);
            $data5 = number_format(($binaan_hadir_januari_5/$jumlah_binaan)*100);
            }
        ?>
        ...
        <?php
            $data1 = number_format(($binaan_hadir_februari_1/$jumlah_binaan)*100);
            $data2 = number_format(($binaan_hadir_februari_2/$jumlah_binaan)*100);
            $data3 = number_format(($binaan_hadir_februari_3/$jumlah_binaan)*100);
            $data4 = number_format(($binaan_hadir_februari_4/$jumlah_binaan)*100);
            $data5 = number_format(($binaan_hadir_februari_5/$jumlah_binaan)*100);
            }
        ?>
        ...
        <?php
            $data1 = number_format(($binaan_hadir_maret_1/$jumlah_binaan)*100);
            $data2 = number_format(($binaan_hadir_maret_2/$jumlah_binaan)*100);
            $data3 = number_format(($binaan_hadir_maret_3/$jumlah_binaan)*100);
            $data4 = number_format(($binaan_hadir_maret_4/$jumlah_binaan)*100);
            $data5 = number_format(($binaan_hadir_maret_5/$jumlah_binaan)*100);
            }
        ?>
        ...
        <?php
            $data1 = number_format(($binaan_hadir_april_1/$jumlah_binaan)*100);
            $data2 = number_format(($binaan_hadir_april_2/$jumlah_binaan)*100);
            $data3 = number_format(($binaan_hadir_april_3/$jumlah_binaan)*100);
            $data4 = number_format(($binaan_hadir_april_4/$jumlah_binaan)*100);
            $data5 = number_format(($binaan_hadir_april_5/$jumlah_binaan)*100);
            }
        ?>
        ...
        <?php
            $data1 = number_format(($binaan_hadir_mei_1/$jumlah_binaan)*100);
            $data2 = number_format(($binaan_hadir_mei_2/$jumlah_binaan)*100);
            $data3 = number_format(($binaan_hadir_mei_3/$jumlah_binaan)*100);
            $data4 = number_format(($binaan_hadir_mei_4/$jumlah_binaan)*100);
            $data5 = number_format(($binaan_hadir_mei_5/$jumlah_binaan)*100);
            }
        ?>
        ...
        <?php
            $data1 = number_format(($binaan_hadir_juni_1/$jumlah_binaan)*100);
            $data2 = number_format(($binaan_hadir_juni_2/$jumlah_binaan)*100);
            $data3 = number_format(($binaan_hadir_juni_3/$jumlah_binaan)*100);
            $data4 = number_format(($binaan_hadir_juni_4/$jumlah_binaan)*100);
            $data5 = number_format(($binaan_hadir_juni_5/$jumlah_binaan)*100);
            }
        ?>
        ...
        <?php
            $data1 = number_format(($binaan_hadir_juli_1/$jumlah_binaan)*100);
            $data2 = number_format(($binaan_hadir_juli_2/$jumlah_binaan)*100);
            $data3 = number_format(($binaan_hadir_juli_3/$jumlah_binaan)*100);
            $data4 = number_format(($binaan_hadir_juli_4/$jumlah_binaan)*100);
            $data5 = number_format(($binaan_hadir_juli_5/$jumlah_binaan)*100);
            }
        ?>
        ...
        <?php
            $data1 = number_format(($binaan_hadir_agustus_1/$jumlah_binaan)*100);
            $data2 = number_format(($binaan_hadir_agustus_2/$jumlah_binaan)*100);
            $data3 = number_format(($binaan_hadir_agustus_3/$jumlah_binaan)*100);
            $data4 = number_format(($binaan_hadir_agustus_4/$jumlah_binaan)*100);
            $data5 = number_format(($binaan_hadir_agustus_5/$jumlah_binaan)*100);
            }
        ?>
        ...
        <?php
            $data1 = number_format(($binaan_hadir_september_1/$jumlah_binaan)*100);
            $data2 = number_format(($binaan_hadir_september_2/$jumlah_binaan)*100);
            $data3 = number_format(($binaan_hadir_september_3/$jumlah_binaan)*100);
            $data4 = number_format(($binaan_hadir_september_4/$jumlah_binaan)*100);
            $data5 = number_format(($binaan_hadir_september_5/$jumlah_binaan)*100);
            }
        ?>
        ...
        <?php
            $data1 = number_format(($binaan_hadir_oktober_1/$jumlah_binaan)*100);
            $data2 = number_format(($binaan_hadir_oktober_2/$jumlah_binaan)*100);
            $data3 = number_format(($binaan_hadir_oktober_3/$jumlah_binaan)*100);
            $data4 = number_format(($binaan_hadir_oktober_4/$jumlah_binaan)*100);
            $data5 = number_format(($binaan_hadir_oktober_5/$jumlah_binaan)*100);
            }
        ?>
        ...
        <?php
            $data1 = number_format(($binaan_hadir_november_1/$jumlah_binaan)*100);
            $data2 = number_format(($binaan_hadir_november_2/$jumlah_binaan)*100);
            $data3 = number_format(($binaan_hadir_november_3/$jumlah_binaan)*100);
            $data4 = number_format(($binaan_hadir_november_4/$jumlah_binaan)*100);
            $data5 = number_format(($binaan_hadir_november_5/$jumlah_binaan)*100);
            }
        ?>
        ...
        <?php
            $data1 = number_format(($binaan_hadir_desember_1/$jumlah_binaan)*100);
            $data2 = number_format(($binaan_hadir_desember_2/$jumlah_binaan)*100);
            $data3 = number_format(($binaan_hadir_desember_3/$jumlah_binaan)*100);
            $data4 = number_format(($binaan_hadir_desember_4/$jumlah_binaan)*100);
            $data5 = number_format(($binaan_hadir_desember_5/$jumlah_binaan)*100);
