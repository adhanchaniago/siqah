...
<table class="bordered striped">
    ...
    <?php
    $i = 1;
    $select = $koneksi->prepare("SELECT nama_kelompok from rekap WHERE nama_murabbi = '$nama_murabbi' GROUP BY nama_kelompok ORDER BY nama_kelompok ASC;");
                $select->execute();
                $select->store_result();
    ...
    <tr>
        <td><?=$i++;?></td>
        <td><?=$nama_kelompok;?></td>
        <td><a href="hasil_rekap_presensi.php?nama=<?=$nama_kelompok;?>">Buka</a></td>
    </tr>
    <?php
                }
                ?>
